...
class RegistrationPageLocators:
    ...
    COUNTRY_ITEM = (By.XPATH, '//div[@class="country-select_i"]')
...
class RegistrationPageHelperHelper(BasePageHelper):
    ...
    def select_random_country(self):
        ...
        with allure.step('Проверяем корректность открытия списка'):
            self.attach_screenshot()
        ...
        with allure.step('Проверяем соответствие кода стране'):
            self.attach_screenshot()
        return country_code
